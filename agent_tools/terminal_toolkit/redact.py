...
def mask_secret(
    ...
    *,
    ...
    Canonical helper for display-time redaction across terminal toolkit — used by
    ``agent config``, ``agent status``, ``agent dump``, and anywhere
