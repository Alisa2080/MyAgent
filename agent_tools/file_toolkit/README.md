...
File operations are backed by shared terminal toolkit active envs created through
...
cached wrappers when terminal toolkit cleans up a task.
...
- `TERMINAL_ENV`: backend used by the shared terminal toolkit env.
