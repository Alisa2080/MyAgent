...
def normalize_read_pagination(offset: Any = DEFAULT_READ_OFFSET,
    ...
    """
    from agent_tools.file_toolkit.tool_output_limits import get_max_lines
...
class ShellFileOperations(FileOperations):
    ...
    def _add_line_numbers(self, content: str, start_line: int = 1) -> str:
        ...
        from agent_tools.file_toolkit.tool_output_limits import get_max_line_length
    ...
    def patch_replace(self, path: str, old_string: str, new_string: str,
        ...
        from agent_tools.file_toolkit.fuzzy_match import fuzzy_find_and_replace
        ...
        if error or match_count == 0:
            ...
            try:
                from agent_tools.file_toolkit.fuzzy_match import format_no_match_hint
    ...
    def patch_v4a(self, patch_content: str) -> PatchResult:
        ...
        """
        # Import patch parser
        from agent_tools.file_toolkit.patch_parser import parse_v4a_patch, apply_v4a_operations
